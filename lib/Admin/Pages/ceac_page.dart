...
import 'package:excel/excel.dart'; // for kIsWeb
import 'file_downloader_mobile.dart'
    if (dart.library.html) 'file_downloader_web.dart';

class CeacPage extends StatefulWidget {
  @override
  _CeacPageState createState() => _CeacPageState();
}

class _CeacPageState extends State<CeacPage> {
  ...
  Future<void> _generateExcelReport(
    ...
    final Sheet sheet = excel['CEAC Students'];
    ...
    final fileName = 'CEAC_Report_$timestamp.xlsx';
