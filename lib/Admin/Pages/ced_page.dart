...
class CedPage extends StatefulWidget {
  @override
  _CedPageState createState() => _CedPageState();
}

class _CedPageState extends State<CedPage> {
  ...
  Future<void> _generateExcelReport(
    ...
    final Sheet sheet = excel['CED Students'];
    ...
    final fileName = 'CED_Report_$timestamp.xlsx';
