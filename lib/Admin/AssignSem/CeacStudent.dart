...
class CEACStudentsPage extends StatefulWidget {
  @override
  _CEACStudentsPageState createState() => _CEACStudentsPageState();
}

class _CEACStudentsPageState extends State<CEACStudentsPage> {
  ...
  Future<void> assignSemesterToAllCEACStudents() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Semester assigned to all CEAC students!')),
      );
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Assign Semester to CEAC Students')),
      body: Padding(
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    .collection('Users')
                    .where('college', isEqualTo: 'CEAC') // Filter by college
                    .snapshots(),
