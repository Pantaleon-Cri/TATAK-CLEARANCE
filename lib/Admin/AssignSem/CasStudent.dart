...
class CASStudentsPage extends StatefulWidget {
  @override
  _CASStudentsPageState createState() => _CASStudentsPageState();
}

class _CASStudentsPageState extends State<CASStudentsPage> {
  ...
  Future<void> assignSemesterToAllCEACStudents() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Semester assigned to all CAS students!')),
      );
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Assign Semester to CAS Students')),
      body: Padding(
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    .collection('Users')
                    .where('college', isEqualTo: 'CAS') // Filter by college
                    .snapshots(),
