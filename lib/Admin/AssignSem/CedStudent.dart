...
class CEDStudentsPage extends StatefulWidget {
  @override
  _CEDStudentsPageState createState() => _CEDStudentsPageState();
}

class _CEDStudentsPageState extends State<CEDStudentsPage> {
  ...
  Future<void> assignSemesterToAllCEACStudents() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Semester assigned to all CED students!')),
      );
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Assign Semester to CED Students')),
      body: Padding(
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    .collection('Users')
                    .where('college', isEqualTo: 'CED') // Filter by college
                    .snapshots(),
